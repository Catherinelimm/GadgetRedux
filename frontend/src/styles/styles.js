const styles = {
  ...
  button: 'w-[150px] bg-[#053B50] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
  cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#053B50] flex items-center justify-center cursor-pointer",
